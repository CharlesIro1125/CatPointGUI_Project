...
public class PretendDatabaseSecurityRepositoryImpl implements SecurityRepository {
    ...
    private static Gson gson; //used to serialize objects into JSON  = new Gson();
    ...
    public PretendDatabaseSecurityRepositoryImpl() {
        ...
        gsonBuilder.registerTypeAdapter(Sensor.class,new SensorInstanceCreator("sensor1",SensorType.DOOR));
